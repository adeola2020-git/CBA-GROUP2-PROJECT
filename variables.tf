...
variable "keyname" {
  default     = "Terraform-KP"     #"ansible-host-1-KP" #"jenkins-kp"
...
# Defining CIDR Block for 1st Public Subnet for us-east-1a
variable "subnet1_cidr" {
  default = "10.1.1.0/24"
  
}

# Defining CIDR Block for 2nd Public Subnet for us-east-1b
variable "subnet2_cidr" {
  default = "10.1.2.0/24"
}

# # Defining CIDR Block for 1st Private Subnet for us-east-1c
variable "subnet3_cidr" {
  default = "10.1.3.0/24"
}

# # Defining CIDR Block for 2nd Private Subnet for us-east-1d
...
variable "public_subnet01_web_server_count" {
  default = 2
}

variable "public_subnet02_web_server_count" {
  default = 2
}
...
# variable "azs" {
#   type    = any
#   default =  ["us-east-1a", "us-east-1b", "us-east-1c", "us-east-1d"]    #["eu-west-2a", "eu-west-2b"]
# }
